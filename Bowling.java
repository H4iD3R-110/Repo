...
public class Bowling {
    ...
    public void bowlingFirst(){
        System.out.println("-- Starting 5-Over Match --");
        System.out.println("\tRules:\n-Press 'Enter' to bowl"
                            + "\n-Opposition have 10 wickets "
                            + "\n-5 overs alloted");
        ...
        Bating bating = new Bating();
        bating.batingSecond(totalRuns+1);
        
    }
    
    public void bowlingSecond(int Target){
        System.out.println("\n\tRules:\n-Press 'Enter' to bowl"
                            + "\n-Opposition have 10 wickets "
                            + "\n-5 overs alloted");
        ...
        for(int i = 1;i<=5;i++){
            ...
            if(i < 5 && Wickets < 10){
                ...
                System.out.println("\nMatch Over");
                if(totalRuns < Target){
                    System.out.println("Defended Successfully");
    ...
    public void Overs(Scanner inp,int target, int over){
        String[] bowling = {"bowled","dot","one","two","three","bowled","four","six","wide","noball","one","two","lbw","three","four","six","caugth"};
        ...
        while(ball < 6){
            ...
            if(shot.equalsIgnoreCase("")){
                int gshot = (int)(Math.random() * 16);
                String shotScore = bowling[gshot];
                switch(shotScore){
                    case "dot":
